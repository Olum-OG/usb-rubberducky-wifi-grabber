...
```You need to change the webhook.site link in the payload.txt for the script to work!```

1. Goto https://webhook.site/ (You don't need to login/register)
2. Copy your unique URL:

![Screenshot 2022-11-24 132958](https://user-images.githubusercontent.com/56028709/203787748-61acb9f6-cbab-4239-aec5-e7b7befb82a0.png)

3. Open payload.txt and paste your unique webhook URL here:
